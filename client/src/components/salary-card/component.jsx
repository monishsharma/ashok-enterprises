...
const SalayDetail = ({
  ...
  <tr>
    ...
    <td style={{ width: "200px" }}>
      <span className="fw-bold">₹{priceFormatter(perDayAmount)}</span> <br />
      {`(${working})`}
    </td>
    <td style={{ width: "150px" }}>
      <span className="fw-bold">₹{priceFormatter(overTimeAmount)}</span> <br />
      {`(${overTime})`}
    </td>

    <td style={{ width: "100px" }}>
      <span className="fw-bold">₹{priceFormatter(sunday.amount)}</span> <br />
      {`(${sunday.count} sun)`}
    </td>
    <td style={{ width: "50px" }}>
      <span> {esi ? "-200" : 0}</span>
...
const SalaryCard = ({
  ...
  return (
    <React.Fragment>
      ...
      {!isLoading && (
        <div className="detailTable mt-2" ref={componentRef}>
